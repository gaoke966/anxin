...
<div class="panel panel-info">	  <div class="panel-heading">程序版本信息</div>	  <div class="panel-body">	    <div class="alert alert-warning alert-dismissable">		  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>		  <strong>官方通知：</strong><?php echo ($tongzhi); ?>		</div>		 <div class="row">		  		  <div class="col-md-6">				<div class="panel panel-default">				  <!-- Default panel contents -->				  <div class="panel-heading">官方推荐</div>				 				  <!-- List group -->				  <ul class="list-group">					<?php echo ($diywapad); ?>				  </ul>				</div>		  </div>		   <div class="col-md-6">				<div class="panel panel-default">				  <!-- Default panel contents -->				  <div class="panel-heading">服务器信息</div>				 				  <!-- List group -->				<table class="table table-bordered table-hover">				<tr class="active">					<td>PHP版本:</td>					<td><?php echo phpversion(); ?></td>				</tr>				<tr class="warning">					<td>操作系统:</td>					<td><?php echo PHP_OS; ?></td>				</tr>				<tr class="success">					<td>程序目录:</td>					<td><?php echo $_SERVER['DOCUMENT_ROOT']; ?></td>				</tr>				<tr class="warning">					<td>端口号:</td>					<td><?php echo $_SERVER['SERVER_PORT'] ; ?></td>				</tr>				<tr class="active">					<td>服务器IP:</td>					<td><?php echo $_SERVER['SERVER_ADDR'] ; ?></td>				</tr>								</table>				</div>		  </div>		  <div class="col-md-12">			<table class="table table-bordered table-hover">				<tr class="active">					<td>程序名称:</td>					<td><?php echo (C("APP_NAME")); ?></td>				</tr>				<tr class="warning">					<td>程序版本:</td>					<td><?php echo (C("VERSION")); ?></td>				</tr>				<tr class="success">					<td>程序开发者:</td>					<td><?php echo (C("AUTHOR")); ?></td>				</tr>				<tr class="warning">					<td>开发者QQ:</td>					<td><?php echo (C("AUTHOR_QQ")); ?></td>				</tr>				<tr class="active">					<td>官方网站:</td>					<td><a href="<?php echo (C("Official")); ?>"><?php echo (C("Official")); ?></a></td>				</tr>			</table>		  </div>		</div>	  </div>	</div></div>
