...
-->
		...
		<div class="well well-sm">模板管理请注意使用UTF-8编码</div>
					<table class="table table-hover table-bordered">
						...
						<?php  $mulu=$_GET['_URL_']; echo '<h4>文件列表</h4>'; $dir =@opendir('./App/Tpl/'.$mulu[3].'/'.$mulu[4].'/'); while(($file = readdir($dir))!=false){ if ($file!="." && $file!="..") { echo '<tr><td>'.$name.'<a href=__GROUP__/Index/htmlmoban/'.$mulu[3].'/'.$mulu[4].'/'.$file.'>'.$file.'</a></td></tr>' ; } } ?>		
